 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Fri Apr  8 15:31:51 2016
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME ACC_Logic_test
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          4
/* Input Port  0 */
#define IN_PORT_0_NAME      en_man
...
/* Output Port  3 */
#define OUT_PORT_3_NAME      lead_us
...
extern void ACC_Logic_test_Outputs_wrapper(const boolean_T *en_man,
                          const real32_T *s,
                          const real32_T *u,
                          const real32_T *H,
                          boolean_T *en_vel,
...
{
    const boolean_T   *en_man  = (const boolean_T*) ssGetInputPortSignal(S,0);
    const real32_T   *s  = (const real32_T*) ssGetInputPortSignal(S,1);
    const real32_T   *u  = (const real32_T*) ssGetInputPortSignal(S,2);
    const real32_T   *H  = (const real32_T*) ssGetInputPortSignal(S,3);
    boolean_T        *en_vel  = (boolean_T *)ssGetOutputPortRealSignal(S,0);
    boolean_T        *en_pos  = (boolean_T *)ssGetOutputPortRealSignal(S,1);
    real32_T        *lead_s  = (real32_T *)ssGetOutputPortRealSignal(S,2);
    real32_T        *lead_us  = (real32_T *)ssGetOutputPortRealSignal(S,3);

    ACC_Logic_test_Outputs_wrapper(en_man, s, u, H, en_vel, en_pos, lead_s, lead_us);
}
