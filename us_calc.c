 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Thu Mar 31 18:19:48 2016
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME us_calc
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
{
    const real32_T   *delta  = (const real32_T*) ssGetInputPortSignal(S,0);
    const real32_T   *psi  = (const real32_T*) ssGetInputPortSignal(S,1);
    const real32_T   *fx  = (const real32_T*) ssGetInputPortSignal(S,2);
    const real32_T   *fy  = (const real32_T*) ssGetInputPortSignal(S,3);
    const real32_T   *u  = (const real32_T*) ssGetInputPortSignal(S,4);
    real32_T        *us  = (real32_T *)ssGetOutputPortRealSignal(S,0);

    us_calc_Outputs_wrapper(delta, psi, fx, fy, u, us);
}
